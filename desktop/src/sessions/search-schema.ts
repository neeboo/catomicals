 ...
 * `packages/session-query/session-query-sqlite/src/schema.ts` (MIT), extended
 * with Catomicals metadata columns (provider/model/executor/title/archived).
 *
 * @module catomicals-desktop/sessions/search-schema
 */
...
/** SQLite application id protecting unrelated databases from derived resets ("CATQ"). */
export const SESSION_QUERY_SQLITE_APPLICATION_ID = 0x43415451;
