...
fn schema_v2_database_upgrades_in_order_to_schema_v7() {
    ...
    raw.execute_batch(
        "DROP TRIGGER chain_executor_claims_no_delete;
         DROP TRIGGER chain_executor_claims_no_update;
         DROP INDEX chain_executor_claims_profile;
         DROP TABLE chain_executor_claims;
         DROP TRIGGER signing_jobs_no_delete;
         DROP TRIGGER signing_jobs_binding_immutable;
         DROP TRIGGER signer_address_bindings_no_delete;
         DROP TRIGGER signer_address_bindings_no_update;
         DROP TRIGGER signer_profiles_no_delete;
         DROP TRIGGER signer_profiles_no_update;
         DROP TABLE signing_jobs;
         DROP TABLE signer_address_bindings;
         DROP TABLE signer_profiles;
